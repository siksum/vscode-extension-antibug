...
Object.defineProperty(exports, "DBOp", { enumerable: true, get: function () { return operation_js_1.DBOp; } });
/*
...
function DBSetTD(TD, blockNumber, blockHash) {
    return operation_js_1.DBOp.set(operation_js_1.DBTarget.TotalDifficulty, rlp_1.RLP.encode(TD), {
        blockNumber,
        blockHash,
    });
}
...
function DBSetBlockOrHeader(blockBody) {
    ...
    dbOps.push(operation_js_1.DBOp.set(operation_js_1.DBTarget.Header, headerValue, {
        blockNumber,
        blockHash,
    }));
    const isGenesis = header.number === util_1.BIGINT_0;
    if (isGenesis ||
        (blockBody instanceof block_1.Block &&
        ...
        dbOps.push(operation_js_1.DBOp.set(operation_js_1.DBTarget.Body, bodyValue, {
            blockNumber,
            blockHash,
        }));
    }
...
function DBSetHashToNumber(blockHash, blockNumber) {
    const blockNumber8Byte = (0, constants_js_1.bytesBE8)(blockNumber);
    return operation_js_1.DBOp.set(operation_js_1.DBTarget.HashToNumber, blockNumber8Byte, {
        blockHash,
    });
}
...
function DBSaveLookups(blockHash, blockNumber, skipNumIndex) {
    ...
    if (skipNumIndex !== true) {
        ops.push(operation_js_1.DBOp.set(operation_js_1.DBTarget.NumberToHash, blockHash, { blockNumber }));
    }
    const blockNumber8Bytes = (0, constants_js_1.bytesBE8)(blockNumber);
    ops.push(operation_js_1.DBOp.set(operation_js_1.DBTarget.HashToNumber, blockNumber8Bytes, {
        blockHash,
    }));
    return ops;
}
