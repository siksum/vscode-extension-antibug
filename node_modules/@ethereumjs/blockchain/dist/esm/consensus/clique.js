...
import { Address, BIGINT_0, BIGINT_1, BIGINT_2, TypeOutput, bigIntToBytes, bytesToBigInt, equalsBytes, hexToBytes, toType, } from '@ethereumjs/util';
...
export class CliqueConsensus {
    ...
    async getCliqueLatestSignerStates() {
        ...
        return states.map((state) => {
            ...
            const addrs = state[1].map((bytes) => new Address(bytes));
