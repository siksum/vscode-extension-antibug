...
import { Chain, ChainGenesis, Common, ConsensusAlgorithm, ConsensusType, Hardfork, } from '@ethereumjs/common';
import { genesisStateRoot as genMerkleGenesisStateRoot } from '@ethereumjs/trie';
import { AsyncEventEmitter, BIGINT_0, BIGINT_1, BIGINT_8, KECCAK256_RLP, Lock, MapDB, bytesToHex, bytesToUnprefixedHex, concatBytes, equalsBytes, } from '@ethereumjs/util';
...
export class Blockchain {
    ...
    async checkAndTransitionHardForkByNumber(number, td, timestamp) {
        ...
        if (!Object.values(ConsensusAlgorithm).includes(this.consensus.algorithm))
            return;
        switch (this.common.consensusAlgorithm()) {
            case ConsensusAlgorithm.Casper:
    ...
    createGenesisBlock(stateRoot) {
        ...
        return Block.fromBlockData({ header, withdrawals: common.isActivatedEIP(4895) ? [] : undefined }, { common });
    }
}
