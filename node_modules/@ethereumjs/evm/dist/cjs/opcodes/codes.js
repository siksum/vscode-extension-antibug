...
function createOpcodes(opcodes) {
    ...
    for (const [key, value] of Object.entries(opcodes)) {
        ...
        result.set(code, new Opcode({
            code,
            fullName: (0, util_js_1.getFullname)(code, value.name),
            ...value,
        }));
    }
    return result;
...
function getOpcodesForHF(common, customOpcodes) {
    ...
    const handlersCopy = new Map(functions_js_1.handlers);
    const dynamicGasHandlersCopy = new Map(gas_js_1.dynamicGasHandlers);
