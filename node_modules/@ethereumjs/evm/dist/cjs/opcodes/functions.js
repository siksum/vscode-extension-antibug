...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState) {
            ...
            const r = (0, util_js_1.mod)(a + b, util_1.TWO_POW256);
    ...
    [
        ...
        function (runState) {
            ...
            if (b === util_1.BIGINT_0) {
                ...
                r = (0, util_js_1.mod)(a / b, util_1.TWO_POW256);
            }
            runState.stack.push(r);
        },
    ],
    ...
    [
        ...
        function (runState) {
            const [a, b] = runState.stack.popN(2);
            const r = (0, util_js_1.fromTwos)(a) < (0, util_js_1.fromTwos)(b) ? util_1.BIGINT_1 : util_1.BIGINT_0;
            runState.stack.push(r);
        },
    ],
    // 0x13: SGT
    ...
    [
        ...
        async function (runState) {
            ...
            const address = new util_1.Address((0, util_js_1.addresstoBytes)(addressBigInt));
    ...
    [
        ...
        async function (runState) {
            ...
            if (dataLength !== util_1.BIGINT_0) {
                const code = await runState.stateManager.getContractCode(new util_1.Address((0, util_js_1.addresstoBytes)(addressBigInt)));
    ...
    [
        ...
        function (runState) {
            ...
            if (runState.env.blobVersionedHashes.length > Number(index)) {
                runState.stack.push((0, util_1.bytesToBigInt)(runState.env.blobVersionedHashes[Number(index)]));
            }
            else {
                runState.stack.push(util_1.BIGINT_0);
            }
    ...
    [
        ...
        function (runState, common) {
            ...
            if (common.isActivatedEIP(6800) && runState.env.chargeCodeAccesses === true) {
                ...
                const statelessGas = runState.env.accessWitness.touchCodeChunksRangeOnReadAndChargeGas(contract, startOffset, endOffset);
            ...
            if (!runState.shouldDoJumpAnalysis) {
                ...
                const loaded = (0, util_1.bytesToBigInt)(runState.code.subarray(runState.programCounter, runState.programCounter + numToPush));
                runState.programCounter += numToPush;
    ...
    [
        ...
        async function (runState) {
            ...
            let recover;
            const ecrecoverFunction = runState.interpreter._evm.common.customCrypto.ecrecover ?? util_1.ecrecover;
            try {
                recover = ecrecoverFunction(msgHash, yParity + util_1.BIGINT_27, r, s);
            }
            catch (e) {
