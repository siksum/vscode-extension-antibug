...
export declare class Interpreter {
    ...
    constructor(evm: EVM, stateManager: EVMStateManagerInterface, blockchain: Blockchain, env: Env, gasLeft: bigint, journal: Journal, performanceLogs: EVMPerformanceLogger, profilerOpts?: EVMProfilerOpts);
     ...
     * Sends a message with arbitrary data to a given address path.
     */
    authcall(gasLimit: bigint, address: Address, value: bigint, data: Uint8Array): Promise<bigint>;
    /**
     ...
     */
    create(gasLimit: bigint, value: bigint, data: Uint8Array, salt?: Uint8Array): Promise<bigint>;
    /**
