...
const buildBlock_js_1 = require("./buildBlock.js");
const runBlock_js_1 = require("./runBlock.js");
const runTx_js_1 = require("./runTx.js");
/**
...
class VM {
    ...
    constructor(opts = {}) {
        ...
        if (opts.stateManager) {
            ...
            this.stateManager = new statemanager_1.DefaultStateManager({ common: this.common });
        }
        this.blockchain = opts.blockchain ?? new blockchain_1.Blockchain({ common: this.common });
    ...
    async init({ genesisState } = {}) {
        ...
        if (this._opts.activatePrecompiles === true && typeof this._opts.stateManager === 'undefined') {
            ...
            for (const [addressStr] of (0, evm_1.getActivePrecompiles)(this.common)) {
                ...
                if (account === undefined) {
                    ...
                    const newAccount = util_1.Account.fromAccountData({
                        balance: 1,
     ...
     */
    async runBlock(opts) {
        return runBlock_js_1.runBlock.bind(this)(opts);
    }
    /**
     ...
     */
    async runTx(opts) {
        return runTx_js_1.runTx.bind(this)(opts);
    }
    /**
    ...
    async buildBlock(opts) {
        return buildBlock_js_1.buildBlock.bind(this)(opts);
    }
    /**
    ...
    async shallowCopy(downlevelCaches = true) {
        ...
        const evmCopy = new evm_1.EVM(evmOpts); // TODO fixme (should copy the EVMInterface, not default EVM)
        return VM.create({
            stateManager,
            blockchain: this.blockchain,
            common,
