...
export async function runTx(opts) {
    ...
    if (opts.tx.supports(Capability.EIP2718TypedTransaction) &&
        ...
        if (opts.tx.supports(Capability.EIP1559FeeMarket) &&
 ...
 */
export async function generateTxReceipt(tx, txResult, cumulativeGasUsed, blobGasUsed, blobGasPrice) {
    const baseReceipt = {
